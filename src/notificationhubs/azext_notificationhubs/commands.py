...
def load_command_table(self, _):
    ...
    with self.command_group('notificationhubs', notificationhubs_namespaces, client_factory=cf_namespaces) as g:
        ...
        g.custom_command('list', 'list_notificationhubs')
        g.custom_command('check-availability', 'check_availability_notificationhubs')
        g.custom_command('list-keys', 'list_keys_notificationhubs')
        g.custom_command('regenerate-keys', 'regenerate_keys_notificationhubs')
        g.custom_command('get-authorization_rule', 'get_authorization_rule_notificationhubs')
        g.custom_command('list-authorization_rules', 'list_authorization_rules_notificationhubs')
        g.custom_command('create-or-update-authorization_rule', 'create_or_update_authorization_rule_notificationhubs')
        g.custom_command('delete-authorization_rule', 'delete_authorization_rule_notificationhubs')
    ...
    with self.command_group('notificationhubs notification-hub', notificationhubs_notification_hubs, client_factory=cf_notification_hubs) as g:
        ...
        g.custom_command('check-notification-hub-availability', 'check_notification_hub_availability_notificationhubs_notification_hub')
